...
- 📝 **שאלון מקיף** - 38 שאלות ב-6 קטגוריות + 2 שאלות חדשות
- 🎯 **ניקוד חכם** - חישוב ציון עמידה 0-100% עם ספירה לאחור לתיקון 13
- ⚠️ **הערכת סיכונים** - זיהוי הפרות וחישוב קנסות פוטנציאליים כולל דיווח 72 שעות
- 📥 **דוחות להורדה** - דוח HTML מפורט ותוכנית פעולה מעודכנת
- 💾 **שמירה אוטומטית** - המשך מהמקום בו הפסקת
- 📊 **מטריצת עמידה** - תמונה מלאה של מצב הארגון
- ⏰ **ספירה לאחור דינמית** - מעקב בזמן אמת עד 14.8.2025
- 🏛️ **חוות דעת מקדמית** - הנחיה לפנייה לרשות
...
### 1. סריקת אתר - שלוש אפשרויות לבחירה

#### 🔒 מצב פרטי 100% (מומלץ!)
1. היכנסו לכלי ובחרו "מצב פרטי 100%"
...
#### 🌐 מצב Proxy (עם הסכמה מפורשת)
1. בחרו "מצב Proxy"
2. קראו ואשרו את אזהרת הפרטיות
3. הזינו כתובת האתר
4. לחצו "נתח עכשיו"
5. הכלי יביא את תוכן האתר דרך שירותי צד שלישי

⚠️ **אזהרה**: מצב זה שולח את כתובת האתר לשירותי Proxy חיצוניים

#### 🔖 מצב Bookmarklet (נוח ופרטי)
1. בחרו "מצב Bookmarklet"
2. גררו את ה-Bookmarklet לסרגל הסימניות
3. בקרו באתר שברצונכם לסרוק
4. לחצו על ה-Bookmarklet
5. הנתונים יועברו אוטומטית לכלי הסריקה

### 2. הערכה עצמית (חדש!)
1. לחצו על כפתור "הערכה עצמית" עם התג "חדש!"
2. ענו על 38 שאלות ב-6 קטגוריות עם תוספות חדשות:
   - פרופיל הארגון
   - ממונה הגנת פרטיות (DPO)
   - רישום מאגרים + דיווח 72 שעות על אירועי אבטחה
   - אבטחת מידע
   - זכויות נושאי מידע
   - עיבוד מידע + חוות דעת מקדמית מהרשות
3. קבלו דוח מקיף הכולל:
   - ציון עמידה כולל (0-100%) עם ספירה לאחור דינמית עד 14.8.2025
   - הערכת סיכונים וקנסות פוטנציאליים כולל קנסות דיווח אירועי אבטחה
   - המלצות מעשיות עם סדר עדיפויות מותאם לזמן הנותר
   - מטריצת עמידה בדרישות מעודכנת
   - הנחיות לבקשת חוות דעת מקדמית מהרשות
4. הורידו דוח HTML מעודכן או תוכנית פעולה משופרת
