...
### 1. סריקת אתר
1. היכנסו לכלי והקליקו על "סריקת אתר" (ברירת מחדל)
2. הזינו כתובת אתר (עם או בלי http/https)
3. לחצו על "בדוק עכשיו"
4. צפו במעקב התקדמות בזמן אמת
5. קבלו דוח מפורט עם ציון והמלצות
...
- ✅ **עיבוד מקומי** - כל החישובים מתבצעים בדפדפן שלך
- ✅ **ללא שמירת מידע** - לא שומרים מידע על אתרים שנסרקו
- ✅ **קוד פתוח** - ניתן לבדוק את הקוד ולוודא שאין דליפות מידע
- ✅ **CORS Proxy** - שימוש בשירותי proxy ציבוריים לעקיפת מגבלות CORS בלבד
- ✅ **LocalStorage** - נתוני ההערכה העצמית נשמרים מקומית בדפדפן בלבד
